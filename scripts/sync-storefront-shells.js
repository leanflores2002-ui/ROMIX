...
<style data-romix-shell-critical>
  *,*::before,*::after{box-sizing:border-box}
  ...
  header[data-romix-shell="header-v1"] .brand-dot{color:#f72585}
  header[data-romix-shell="header-v1"] .header-actions-left,header[data-romix-shell="header-v1"] .mobile-drawer-header{display:none}
  ...
  .site-footer[data-romix-shell="footer-v1"]{background:#222225;color:#fff}
  ...
  .site-footer[data-romix-shell="footer-v1"] .footer-logo-media img{width:72px;height:72px;object-fit:contain}
  ...
  @media(max-width:900px){
    ...
    header[data-romix-shell="header-v1"] .mobile-drawer-header{display:flex;align-items:center;justify-content:space-between;min-height:68px}
...
<header class="site-header romix-shared-header" data-romix-shell="header-v1">
  <div class="container header-row">
    <div class="header-actions-left" aria-label="Acciones principales">
      <button class="icon-btn mobile-menu-btn" id="toggle-mobile-nav" type="button" aria-label="Abrir men&uacute;" aria-controls="header-mobile-nav" aria-expanded="false"><span class="romix-emoji" aria-hidden="true">&#9776;</span></button>
      <button class="icon-btn header-search-mobile" type="button" data-search-toggle="true" aria-label="Abrir buscador" aria-controls="header-search" aria-expanded="false"><span class="romix-emoji" aria-hidden="true">&#8981;</span></button>
    </div>
    ...
    <nav class="mega-nav" id="header-mobile-nav" aria-label="Principal">
      <div class="mobile-drawer-header">
        ...
        <button class="mobile-drawer-close" id="close-mobile-nav" type="button" aria-label="Cerrar men&uacute;"><span class="romix-emoji" aria-hidden="true">&#10005;</span></button>
      </div>
    ...
    <div class="header-icons" aria-label="Acciones r&aacute;pidas">
      <button class="icon-btn header-search-desktop" type="button" data-search-toggle="true" aria-label="Abrir buscador" aria-controls="header-search" aria-expanded="false"><span class="romix-emoji" aria-hidden="true">&#8981;</span></button>
      <a class="cart-pill" href="cart.html" aria-label="Carrito de compras">
        <span class="cart-pill__icon romix-emoji" aria-hidden="true">&#9635;</span>
  ...
  <div class="footer-shell">
    <div class="footer-top">
      <div class="footer-brand">
        <a href="index.html" class="footer-logo" aria-label="ROMIX inicio">
          <picture class="footer-logo-media">
            <source srcset="images/optimized/logo-romix-240.webp 240w, images/optimized/logo-romix-480.webp 480w" sizes="88px" type="image/webp" />
            <img src="images/logo-romix.png" alt="ROMIX" width="752" height="829" loading="lazy" decoding="async" />
          </picture>
          <span class="footer-logo-copy"><strong>ROMIX</strong><span>Sportswear &amp; Fashion</span></span>
        </a>
        ...
        <div class="footer-contact" aria-label="Contacto ROMIX">
          <a class="footer-contact-item footer-contact-item--link" href="https://wa.me/5491154272065" target="_blank" rel="noopener"><span class="romix-emoji" aria-hidden="true">&#9742;</span><span>+54 9 11 5427-2065</span></a>
          <span class="footer-contact-divider" aria-hidden="true"></span>
          <span class="footer-contact-item"><span class="romix-emoji" aria-hidden="true">&#8962;</span><span>CABA, Argentina</span></span>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      ...
      <div class="footer-socials" aria-label="Redes sociales">
        <a href="https://www.instagram.com/romixdamasalbertina/" target="_blank" rel="noopener" aria-label="Instagram"><span class="romix-emoji" aria-hidden="true">&#9678;</span></a>
        <a href="https://www.facebook.com/p/ROMIX-concordia-514-100040099371330/" target="_blank" rel="noopener" aria-label="Facebook"><span class="romix-emoji" aria-hidden="true">f</span></a>
        <a href="https://www.tiktok.com/@romix_tienda?_r=1&amp;_t=ZS-97FOkImZhLN" target="_blank" rel="noopener" aria-label="TikTok"><span class="romix-emoji" aria-hidden="true">&#9834;</span></a>
        <a href="https://wa.me/5491154272065" target="_blank" rel="noopener" aria-label="WhatsApp"><span class="romix-emoji" aria-hidden="true">&#9673;</span></a>
      </div>
    </div>
  </div>
</footer>
