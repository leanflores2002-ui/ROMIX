(function () {
  ...
  var footerHtml = [
    ...
    '        <li><a href="ayuda.html#size-guide">Gu&iacute;a de talles</a></li>',
    '        <li><a href="ayuda.html#contact">Contacto</a></li>',
    '      </ul>',
    '    </nav>',
    '',
    '    <nav class="footer-column" aria-label="Nosotros">',
    '      <h4>Nosotros</h4>',
    '      <ul>',
    '        <li><a href="ayuda.html#contact">Sobre ROMIX</a></li>',
    '        <li><a href="ayuda.html#contact">Trabaj&aacute; con nosotros</a></li>',
    '        <li><a href="ayuda.html#payments">T&eacute;rminos</a></li>',
    '        <li><a href="ayuda.html#payments">Formas de pago</a></li>',
    '      </ul>',
    '    </nav>',
    '',
    '    <nav class="footer-column" aria-label="Redes sociales">',
    '      <h4>Redes</h4>',
    '      <ul>',
    '        <li><a href="https://www.instagram.com/romixdamasalbertina/" target="_blank" rel="noopener">Instagram</a></li>',
    '        <li><a href="https://www.facebook.com/p/ROMIX-concordia-514-100040099371330/" target="_blank" rel="noopener">Facebook</a></li>',
    '        <li><a href="https://www.tiktok.com/@romix_tienda?_r=1&_t=ZS-97FOkImZhLN" target="_blank" rel="noopener">TikTok</a></li>',
    '        <li><a href="https://wa.me/5491154272065" target="_blank" rel="noopener">WhatsApp</a></li>',
    '      </ul>',
    '      <div class="footer-payments" aria-label="Medios de pago">',
    '        <span>Transferencia</span><span>Efectivo</span><span>Mercado Pago</span>',
    '      </div>',
    '    </nav>',
    '  </div>',
    '',
